...
if __name__ == '__main__':
	...
	parser.add_option('-s','--minsize',action = 'store',type = 'string',dest = 'minsize',default = '1M',help = 'min file size to download.default is 8192MB.')
	...
	parser.add_option('-V','--maxviews',action = 'store',type = 'int', dest = 'maxviews',default = 9999999999999,help = 'max views to download. default is 9999999999999')
	parser.add_option('-v','--minviews',action = 'store',type = 'int', dest = 'minviews',default = 1,help = 'min views to download. default is 1')
